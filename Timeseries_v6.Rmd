...
As we find errors in the dataset (often due to errors on the submitter's part) they can be fixed here

In spring 2025 we noticed that the 2023 secchi depth data for Twin Lake Upper (27004201) and Middle (27004202) was measured in ft but assigned the unit of m. The secchi depth was greater than the depth of the lake in some instances.

```{r}
AllData2 <- AllData1 %>%
  mutate(result = case_when((DOW == "27004201" | DOW == "27004202") & parameter == "secchi.m" & sampleYear == 2023 ~ result/3.281,
                             TRUE ~ result))
